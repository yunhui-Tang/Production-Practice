package org.jeecg.modules.xwow.order.entity;
 ...
 */
@Data
@TableName("xw_order_main")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@ApiModel(value="xw_order_main对象", description="订单主表")
public class XwOrderMain implements Serializable {
